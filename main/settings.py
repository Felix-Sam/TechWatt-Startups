...
SECRET_KEY = 'django-insecure-avekauf7ew$h$@tf%i^qsv+^)om3o7go$oas9qf=v@^4lnjh)f'
...
# SECURE_SSL_REDIRECT: Make sure this is enabled True. so all traffic goes through HTTPS.